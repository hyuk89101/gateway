...
@Component
public class CustomPgFilter extends AbstractGatewayFilterFactory<CustomPgFilter.Config> {

    private final WebClient.Builder webClientBuilder;

    public CustomPgFilter(WebClient.Builder webClientBuilder) {
